...
[![인터랙티브 가이드](https://img.shields.io/badge/🖥_인터랙티브_가이드-HTML-1F7D4A)](https://jyt6640.github.io/algo-study/)
...
> 📄 **전체 그림 가이드** → [사용법 PDF](./docs/사용법.pdf) · [인터랙티브 HTML](https://jyt6640.github.io/algo-study/)
...
> 최신 확장은 **연동 토큰만** 입력하면 된다(‘API 주소’ 칸 제거, v0.6.5). 확장을 업데이트했다면 열려 있던 LeetCode·프로그래머스 **탭을 새로고침**할 것.
